...
// uniq(names, callback) => callback = (uniqArr = console.log('The new names array with all the duplicate items removed is [UNIQARRPARAM].'))
...
// each(names, callback => console.log(`the item at index ${i} is ${arr[i]}`))
