...
const funcName = (parameter1, parameter2) => console.log(parameter1, parameter2)
...
greeting("Jon", "Hartwell", (fullName) => console.log (`hello, my name is ${fullName}`))

// greeting('Jon', 'Hartwell', fullName)
...
const pricePlusTax = (prices, callback) => {
...
pricePlusTax(prices, (totalCost) => {
    console.log('The new prices plust tax =', totalCost)
}
)
